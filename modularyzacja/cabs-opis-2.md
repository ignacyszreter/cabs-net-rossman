...
### 6. Zamawianie w cudzym imieniu

Przejazd nie zawsze zamawia rzeczywisty pasażer. Przypadki użycia wyglądają następująco:

- **Firma** zamawia przejazdy dla swoich pracowników. Pracownik jest pasażerem, firma rozlicza się
  miesięcznie. Firma ustawia pracownikowi miesięczny limit kwotowy i listę dozwolonych klas auta.
- **Asystent** zamawia przejazdy dla przełożonego z jego konta i na jego koszt.
- **Biuro** zamawia przejazd dla klienta, który dzwoni na infolinię.
- **Partner z umową** — hotel albo restauracja — zamawia przejazd dla swojego gościa i rozlicza go
  w ramach własnej umowy.

Klient musi w każdej chwili mieć wgląd w to, **kto może zamawiać przejazdy na jego koncie i na jego koszt**. Gdy
klient zgłosi kradzież tożsamości albo firma zwolni pracownika w trybie natychmiastowym, wszystkie
te uprawnienia mają zniknąć natychmiast.

---

### 7. Roszczenia

Klient zgłasza roszczenie do przejazdu, podając numer roszczenia, powód i opis zdarzenia. Inicjalny stan roszczenia to draft, potem kierowane jest do rozpatrzenia. 

Część roszczeń system rozstrzyga automatycznie, używając następujących reguł:
- drugie roszczenie do tego samego przejazdu idzie do biura,
- klient, który zgłosił dotąd najwyżej trzy roszczenia, dostaje zwrot od razu,
- klient VIP dostaje zwrot od razu, jeśli cena przejazdu jest poniżej progu; powyżej progu sprawa
  idzie do biura, a kierowca dostaje prośbę o szczegóły,
- klient zwykły z odpowiednio długą historią przejazdów dostaje zwrot od razu. Bez odpowiednio długiej historii
  roszczenie kierowane jest do biura.

---

### 8. Naprawy floty

Auto trafia do warsztatu na przegląd okresowy albo na naprawę. Na czas pobytu w warsztacie auto
znika z puli dostępnych aut. Zlecenie naprawy ma zakres prac, termin i wycenę.

Naprawę może finansować inny podmiot niż firma: producent auta z tytułu gwarancji, ubezpieczyciel z
tytułu wykupionej ochrony albo leasingodawca z tytułu umowy leasingu. **Zakres prac pokrytych przez
ten podmiot zależy od umowy** — jedna umowa pokrywa wymianę skrzyni biegów, inna tylko przegląd
okresowy. Biuro musi wiedzieć przed zleceniem prac, kto za nie zapłaci i co dokładnie pokrywa.

Prace wykonuje mechanik. Mechanik ma uprawnienia do konkretnych rodzajów prac: elektryka, skrzynia
biegów, blacharstwo, przegląd okresowy. Zlecenie trafia tylko do mechanika z właściwym uprawnieniem.

---

### 9. Wymagania krytyczne

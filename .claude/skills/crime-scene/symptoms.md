...
- **A cluster that does not match the row stays out of the report.** Sections 1 to 3 already carry
  its numbers, and the reader knows the domain you do not.
...
Name the symptom after what the history looks like, not after the fix. `Registration coupling` says
what you saw; `Move the mapping out` says what you decided, and hides the evidence that led there.
